...
public void run(String... args) throws Exception {
	...
	Division division0 = divisionRepo.save(new Division("SOUTH", "AFC", 3));
	...
	Division division1 = divisionRepo.save(new Division("NORTH", "NFC", 4));
	...
	Division division2 = divisionRepo.save(new Division("SOUTH", "AFC", 5));
	...
	Division division3 = divisionRepo.save(new Division("NORTH", "AFC", 6));
	...
	Division division4 = divisionRepo.save(new Division("EAST", "NFC", 4));
